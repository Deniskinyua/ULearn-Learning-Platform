...
namespace ULearn.LP.Core.Entities;
...
public partial class OnlineCourseDbContext : DbContext
{
    ...
    //Pass sql connection string details from the program.cs dependency injection
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=localhost\\sqlpreview,1433;User=sa;Password=Dennis123;Initial Catalog=OnlineCourseDB;TrustServerCertificate=True;");
    //These helps EF core to know where what we try to insert/update is valid or not
